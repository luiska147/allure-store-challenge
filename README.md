...
## La estructura del proyecto y organización de los archivos se encuentra en la siguiente lista: 
...
* Se obtuvieron graficos de productos mas y menos vendidos, calificación promedio por tienda e ingresos totales.
...
Al abrir el archivo AluraStoreLatam.ipynb encontraras el análisis y codigo ejecutado en el proyecto, el cual puedes clonar a tu repositorio local o tambien puedes ejecutar directamente en un Colab Notebook. 
